...
RPCFunction rpcacc(&get_Acc, "get_Acc");
...
int main(){
   ...
   xbee.write("ATMY 0x269\r\n", 12);
   reply_messange(xbee_reply, "setting MY : 0x269");
   xbee.write("ATDL 0x169\r\n", 12);
   reply_messange(xbee_reply, "setting DL : 0x169");
